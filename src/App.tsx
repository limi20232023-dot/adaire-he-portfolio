...
// Using a fresh storage key guarantees that Terry Yao's new configuration loads immediately
// without being blocked or overwritten by the old Alexander Chen cached localStorage state.
const STORAGE_KEY = 'student_portfolio_data_terry_v2';
